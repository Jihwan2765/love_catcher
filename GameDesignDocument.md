...
- **보상 유형:**
    ...
    4. 사탕
- **기본 확률:** 남성용은 레전더리 10%, 인형 20%, 인스타 40%, 사탕 30%이며, 여성용은 레전더리 10%, 인형 40%, 인스타 20%, 사탕 30%입니다.
- **인스타 미입력:** 인스타 확률을 사탕 확률에 합산합니다. 인스타 지급 대상이 없거나 Firebase 조회에 실패하면 인스타를 제외한 나머지 보상을 기존 비율대로 재추첨합니다.
